...
public partial class RecurringTransactionsPage
{
    private readonly RecurringTransactionsPageViewModel _viewModel;

    public RecurringTransactionsPage(RecurringTransactionsPageViewModel viewModel)
    {
        InitializeComponent();
    ...
    private void RecurringTransactionsPage_OnNavigatedTo(object? sender, NavigatedToEventArgs e)
    {
        ProcessAction(async () =>
        {
